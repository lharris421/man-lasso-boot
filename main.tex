...
We see the shortcomings of constructing HDCIs arising from two issues when proposing to use bootstrapping for the lasso. We will refer to these issues as,
...
\begin{figure}[hbtp]
  \includegraphics[width=\linewidth]{comparison_data_original}
...
\begin{figure}[hbtp]
  \includegraphics[width=\linewidth]{comparison_data_scheetz_original}
