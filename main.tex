...
\logan{Will need to update with true lambda stuff moved to supplement.}
...
and implies a Laplace rate of $\lam=\sqrt{2/p}$, since $\sum_{j=1}^p\Ex(\beta_j^2|\lam=\sqrt{2/p}) = 1$
