...
\logan{It is worth noting that in the above theorem we are focused on the average coverage of a single $\theta_j$ but still integrated over the joint posterior}. As a direct result of the theorem, however, then the average coverage of $p$ intervals will also be greater than or equal to $1-\alpha$:
