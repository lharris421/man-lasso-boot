...
packages <- c("dplyr", "tidyr", "ggplot2", "ncvreg", "gridExtra", "scales", "kableExtra", "grid", "glue", "lme4", "gam")
...
method <- "quantile"
method_pretty <- c("traditional" = "Traditional", "sample" = "Random Sample", "debiased" = "Debias", "acceptreject" = "Accept/Reject", "zerosample1" = "Zero Sample Single", "zerosample2" = "Zero Sample")
